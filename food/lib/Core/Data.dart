...
List<Categories> categories = [
  Categories(id: 0, name: 'Dinning Food', image: 'assets/icon/chicken-leg.svg'),
  Categories(id: 1, name: 'Sea Food', image: 'assets/icon/fish.svg'),
  Categories(id: 2, name: 'Chinese Food', image: 'assets/icon/pizza.svg'),
  Categories(id: 3, name: 'Fast Food', image: 'assets/icon/cut.svg'),
];
